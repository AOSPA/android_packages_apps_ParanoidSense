...
object Constants {
    ...
    const val SHARED_KEY_ENROLL_TOKEN = "token"
    const val SHARED_KEY_FACE_ID = "name"
    const val SHARED_KEY_SDK_VERSION = "sdk_version"
    const val SHARED_KEY_UUID = "uuid"
    const val MG_UNLOCK_ATTR_EYE_CLOSE = 22
