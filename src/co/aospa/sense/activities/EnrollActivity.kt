...
import co.aospa.sense.camera.CameraFaceEnrollController.CameraCallback
...
open class EnrollActivity : FaceBaseActivity() {
    ...
    private var mEnrollController: CameraFaceEnrollController? = null
    ...
    private fun init() {
        ...
        if (mEnrollController == null) {
            mEnrollController = CameraFaceEnrollController.instance
